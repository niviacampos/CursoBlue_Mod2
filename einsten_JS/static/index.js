...
const pessoa = {
    nome: 'Betão', sobrenome: 'Einstein', idade: 42, doido: false, imagem_serio: 'https://upload.wikimedia.org/wikipedia/commons/5/50/Albert_Einstein_%28Nobel%29.png',
...
const elementoBotao = document.getElementById("alteraHumor"); // Atribuir os valores iniciais 
